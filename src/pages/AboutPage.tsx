    ...
    <main className="about-page">
      <section className="about-hero">
        ...
        <div className="about-hero-inner">
          ...
          <div className="about-hero-note"><span className="about-avatar-stack"><i /><i /><i /></span><span>Built for the people, artists, organizers, venues, and communities shaping Burundi&apos;s event culture.</span></div>
        </div>
      ...
      <section className="about-impact about-section-shell">
        <div className="about-impact-heading"><div><div className="about-section-label">02 / Our impact</div><h2>More people in<br /><span>the room.</span></h2></div><div className="about-impact-copy"><p>Every organizer who launches and every attendee who shows up helps build a more connected event community in Burundi.</p><span className="about-impact-rule" /></div></div>
        <div className="about-metrics"><Metric value="24/7" label="Discoverable events" /><Metric value="1 place" label="For the ticket journey" /><Metric value="100%" label="Built around people" /><Metric value="∞" label="Reasons to show up" /></div>
