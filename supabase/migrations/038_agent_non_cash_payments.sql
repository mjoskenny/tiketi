-- Agents use the same trusted payment checkout as customers.
-- Cash is intentionally excluded from new agent sales.
...
ALTER TABLE public.agent_sales
  ...
  CHECK (payment_mode IN ('mobile_money', 'card', 'bank')) NOT VALID;
