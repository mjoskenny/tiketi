-- Active agent assignments are the source of truth for agent sale authorization.
-- Do not require a separately active organizer membership, since older membership
-- rows can remain pending after an assignment is activated.
